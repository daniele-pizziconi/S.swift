...
extension __FooView: AppearaceProxyComponent {
	...
	public typealias ApperanceProxyType = StyleDark.__FooViewAppearanceProxy
	public var appearanceProxy: ApperanceProxyType {
		get {
			guard let proxy = objc_getAssociatedObject(self, &__ApperanceProxyHandle) as? ApperanceProxyType else { return StyleDark.__FooView }
			return proxy
		}
		set {
