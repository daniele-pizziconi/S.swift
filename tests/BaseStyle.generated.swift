...
public extension Notification.Name {
	static let didChangeTheme = Notification.Name("basestylesheet.theme")
}
...
public class StylesheetManager {
	...
	public init() {
		self.theme = UserDefaults.standard[DefaultKeys.theme] ?? .base
	}
}
...
public class BaseStyle: NSObject {
	...
	public class ButtonAppearanceProxy {
		let mainProxy: () -> BaseStyle
		init(proxy: @escaping () -> BaseStyle) {
	...
	public class DurationAppearanceProxy {
		let mainProxy: () -> BaseStyle
		init(proxy: @escaping () -> BaseStyle) {
			self.mainProxy = proxy
		}
		...
		public class intervalAppearanceProxy {
			let mainProxy: () -> BaseStyle
			init(proxy: @escaping () -> BaseStyle) {
				self.mainProxy = proxy
			}
	...
	public class TypographyAppearanceProxy {
		...
		public class textStylesAppearanceProxy {
			let mainProxy: () -> BaseStyle
			init(proxy: @escaping () -> BaseStyle) {
				self.mainProxy = proxy
			}
	...
	open class AnimatorAnimatorProxy {
		...
		public class rotateAppearanceProxy {
			let mainProxy: () -> BaseStyle
			init(proxy: @escaping () -> BaseStyle) {
				self.mainProxy = proxy
			}
...
extension Button: AppearaceProxyComponent {
	...
	public var appearanceProxy: ApperanceProxyType {
		get {
			...
			return StylesheetManager.stylesheet(BaseStyle.shared()).Button
		}
		set {
...
extension UIView: AnimatorProxyComponent {
	...
	public var animator: AnimatorProxyType {
		get {
			guard let a = objc_getAssociatedObject(self, &__AnimatorProxyHandle) as? AnimatorProxyType else { return StylesheetManager.stylesheet(BaseStyle.shared()).Animator }
			return a
		}
